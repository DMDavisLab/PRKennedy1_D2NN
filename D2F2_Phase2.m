...
% overlapping the image sensor edge) are unreliably detected anyway.
...
%==========================================================================
% The array 'data_proc' holds only events within the ROI but processed
% relative to the entire image. It is faster to only measure for events 
% that are in the ROI.
...
%==========================================================================
% generate x and y values to the nearest 10th nm to match the in-ROI 
